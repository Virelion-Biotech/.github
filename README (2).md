...
Virelion's public website explicitly notes that the therapeutic programs are still in discovery and preclinical development and that public technical material will be added as the science matures.

Accordingly, this README intentionally distinguishes between:

- **What Virelion publicly says it is building**
- **What stage a program is publicly listed at**
- **What evidence has actually been disclosed**

At the time summarized here, the portfolio is best understood as an early research and development effort rather than a clinically validated therapeutic platform.

---

## Disclaimer

This document is a company overview derived from Virelion Biotech's public website and is intended for informational purposes.

Nothing here should be interpreted as a representation that Virelion's research programs are clinically validated, regulator-approved, commercially available, or proven safe or effective. In particular, the company's own site states that its programs are in discovery and that tools such as Virelion-CardioScore and Virelion-Biosafety-Assessment are research/planning aids rather than validated regulatory or institutional substitutes.

For the latest program status, scientific disclosures, repository contents, or contact information, consult the official Virelion website and its linked public resources.

---

## Source

Primary source used for this README:

**Virelion Biotech — Engineering the Heart**  
https://virelionbiotech.netlify.app/

Content in this README is a structured summary of information publicly presented on that site, current to **17 August 2026**.
